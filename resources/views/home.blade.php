									...
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
												...
												$ {{number_format(\App\Models\invoices::sum('Total'),3)}}

											</h4>
											 <button type="button" class="btn bg-primary-gradient position-relative">
												عدد الفواتير
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
												$ {{number_format(\App\Models\invoices::where('Value_Status',2)->sum('Total'),3)}}
											</h4>
											<button type="button" class="btn bg-danger-gradient position-relative">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<button type="button" class="btn bg-success-gradient position-relative">
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">${{\App\Models\invoices::where('Value_Status',1)->count()}}</h4>
											<button type="button" class="btn bg-warning-gradient position-relative">
												عدد الفواتير المدفوعة
												<span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-info">
													{{\App\Models\invoices::where('Value_Status',1)->count()}}
												</span>
