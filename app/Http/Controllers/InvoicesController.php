...
class InvoicesController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('invoices.invoices_edit_invoice', compact('invoices', 'sections'));
    }
    ...
    {
        return \Excel::download(new InvocesExport, 'invoice.xlsx');
    }
    ...
    public function unreadNotifications_count(Request $request)
    {
        # code...
    }
}
